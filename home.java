...
public class home extends JFrame {
    ...
    private JPanel HomePanel() throws MalformedURLException {
        ...
        for (int i = 0; i < lessons.length; i++) {
            ...
            JPanel buttonPanel = attributes.createStyledButton(Integer.parseInt(lessons[i][0]), lessonTitle);
...
//            case 3 -> newStage = new ThirdStage();
    ...
    private JPanel createTopBar() throws MalformedURLException {
        ...
        JLabel hearts = createStatLabel("C O D E X");
    ...
    private JLabel createStatLabel(String text) throws MalformedURLException {
